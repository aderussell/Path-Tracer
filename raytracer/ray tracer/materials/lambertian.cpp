...
bool lambertian::scatter(const Ray& ray_in, const SurfaceInteraction& hrec, scatter_record& srec) const {
...
float lambertian::scattering_pdf(const Ray& ray_in, const SurfaceInteraction& rec, Ray& scattered) const {
